...
export const socialControlChangeSchema = z.object({
...
export function applySocialControlChange(current: SocialControlRecord, input: z.infer<typeof socialControlChangeSchema>): SocialControlRecord {
  ...
  return { enabled: false, circuitStatus: "paused", pauseReason: "manual_pause", pauseEvidenceRef: parsed.evidenceRef };
}
