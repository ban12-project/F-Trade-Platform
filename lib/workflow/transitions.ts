...
const rules: readonly TransitionRule[] = [
  ...
  { entityType: "video", fromState: "VIDEO_DRAFT", toState: "VIDEO_REVIEW_REQUIRED", actors: ["human"] },
  { entityType: "video", fromState: "VIDEO_DRAFT", toState: "VIDEO_READY_FOR_GENERATION", actors: ["agent", "human"] },
  { entityType: "video", fromState: "VIDEO_DRAFT", toState: "VIDEO_RENDERING", actors: ["human"] },
  { entityType: "video", fromState: "VIDEO_REVISION_REQUIRED", toState: "VIDEO_RENDERING", actors: ["human"] },
  { entityType: "video", fromState: "VIDEO_RENDERING", toState: "VIDEO_REVIEW_REQUIRED", actors: ["system"] },
  { entityType: "video", fromState: "VIDEO_RENDERING", toState: "VIDEO_REVISION_REQUIRED", actors: ["system"] },
  ...
  { entityType: "video", fromState: "VIDEO_REVISION_REQUIRED", toState: "VIDEO_REVIEW_REQUIRED", actors: ["human"] },
  { entityType: "video", fromState: "VIDEO_APPROVED", toState: "VIDEO_READY_FOR_GENERATION", actors: ["human", "system"] },
  { entityType: "video", fromState: "VIDEO_READY_FOR_GENERATION", toState: "VIDEO_DRAFT", actors: ["agent", "human"] },
