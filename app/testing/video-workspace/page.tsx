...
const products: ReadyVideoProductSource[] = [
  {
      ...
      clips: [
        {
          ...
          audioMode: "muted",
          caption: { kind: "none" },
          abcdRoles: ["attention", "branding"],
          motionPreset: "punch_in",
        },
        {
          clipId: "clip-002",
          assetRef: "evidence-image-002",
          mediaType: "image",
          trimStartMs: 0,
          durationMs: 3_000,
          fitMode: "contain",
          audioMode: "muted",
          caption: { kind: "none" },
          abcdRoles: ["connection", "direction"],
...
async function VideoWorkspaceFixture({
  ...
  return (
    <VideoWorkspace
      projectId={projectId}
      projectTitle="Synthetic project workspace"
      products={products}
      entries={[current]}
      copyCandidates={[]}
      canReview
...
export default function VideoWorkspaceTestingPage({
  ...
  return (
    <Suspense fallback={null}>
      <VideoWorkspaceFixture searchParams={searchParams} />
    </Suspense>
  );
}
