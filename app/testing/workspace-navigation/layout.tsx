...
export default function Layout({ children }: { children: ReactNode }) {
  ...
  return <WorkspaceShell dock={<Suspense fallback={<WorkspaceDockSkeleton />}><WorkspaceActionDock projects={[navigationProject]} tasks={[]} basePath="/testing/workspace-navigation" /></Suspense>}>{children}</WorkspaceShell>;
}
