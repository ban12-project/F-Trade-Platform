    ...
    <main id="main-content" className="min-h-svh overflow-hidden bg-muted/30">
      <div className="mx-auto flex min-h-svh w-full max-w-6xl flex-col px-4 py-5 sm:px-6 lg:px-8">
        <header className="flex items-center justify-between gap-4">
          <Link
            href="/"
            className="flex items-center gap-2.5 rounded-md text-sm font-semibold tracking-tight focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
          >
            <span
          ...
          <div className="motion-landing-enter flex flex-col gap-7">
            ...
            <div className="flex flex-col gap-5">
              ...
              <p className="max-w-2xl text-base leading-7 text-muted-foreground text-pretty sm:text-lg">
                F-Trade
                在同一工作流中整理工厂资料、产品字段和内容草稿。先核实每项产品事实，再将其用于获客内容。
              </p>
            </div>
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              <LinkButton href="/auth" size="lg">
                进入工作台 <ArrowRightIcon data-icon="inline-end" />
              </LinkButton>
              <LinkButton href="/workspace" size="lg" variant="outline">
                查看工作台
              </LinkButton>
            </div>
            <p className="text-xs leading-5 text-muted-foreground">
              仅受邀用户可访问 · 不生成正式报价、交期或未经确认的工程事实
            </p>
          </div>
            ...
            <Card className="relative overflow-hidden rounded-2xl shadow-xl">
              ...
              <CardContent className="flex flex-col gap-5 p-6">
                ...
                <div className="rounded-xl border border-dashed bg-muted/20 p-4 text-sm leading-6 text-muted-foreground">
                  <span className="font-medium text-foreground">核心原则：</span>
                  营销语言可以生成，工程事实必须来自工厂来源或人工确认。
                </div>
              </CardContent>
            </Card>
          </div>
