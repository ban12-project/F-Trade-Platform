...
export function ContentReviewPanel({ content, canReview }: { content: ContentCatalogDetail; canReview: boolean }) {
  ...
  const canDecide = canReview && content.state === "CONTENT_REVIEW_REQUIRED" && content.approvalStatus === "pending";
