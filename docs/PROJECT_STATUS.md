...
| M3 | 询盘澄清、RFQ Ready、人工报价交接 | RFQ 补全、Product Ready 引用、人工报价录入、Gate 02 审核和发送凭据已实现；合成销售闭环由 `tests/database-browser/sales.spec.ts` 验证，真实客户试点仍待验收 |
...
工作区正按批次改为今日任务、产品资料、内容与发布、客户与询盘；项目保留资料归属和成员权限，编辑区作为页面主区域。交付状态见[以业务任务与对象组织工作区](decisions/0007-task-oriented-workspace.md)。
