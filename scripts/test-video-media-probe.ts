...
const receipt = createReviewVideoExport({ videoId: "00000000-0000-4000-8000-000000000601", sourceAssetRef: "asset-video-601", platform: "tiktok", media: measured, timeline: { durationSeconds: 5 } });
