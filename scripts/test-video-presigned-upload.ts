...
import { completedVideoUploadTokenSchema, mediaTypeForVideoUpload, videoPresignedUploadPayloadSchema, videoPresignedUploadUsesMultipart, videoUploadBlobPath } from "../lib/video/upload-contracts";
...
assert.equal(videoPresignedUploadUsesMultipart, false, "the client must use one PUT rather than multipart POST /mpu");
