...
import { completedVideoUploadTokenSchema, maximumVideoUploadImageBytes, maximumVideoUploadVideoBytes, mediaTypeForVideoUpload, shouldUseMultipartVideoUpload, videoPresignedUploadPayloadSchema, videoUploadBlobPath, videoUploadMultipartThresholdBytes } from "../lib/video/upload-contracts";
...
assert.throws(() => videoPresignedUploadPayloadSchema.parse({ ...payload, sizeBytes: 1024 * 1024 * 1024 }));
