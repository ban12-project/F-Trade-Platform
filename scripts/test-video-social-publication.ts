...
async function main() {
  ...
  const facebookReview = approveReviewVideoExport(createReviewVideoExport({ videoId: "00000000-0000-4000-8000-000000000702", sourceAssetRef: "asset-video-702", platform: "facebook", media: measured }), "evidence-export-702");
